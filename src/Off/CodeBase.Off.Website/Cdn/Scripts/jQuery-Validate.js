    ...
    c.extend(c.validator, {
        ...
        prototype: {
            ...
            findLastActive: function() {
                ...
                return a && c.grep(this.errorList, function(b) { return b.element.name == a.name; }).length == 1 && a;
            },
            elements: function() {
                var a = this, b = { };
        ...
        methods: {
            ...
            equalTo: function(a, b, d) {
                d = c(d).unbind(".validate-equalTo").bind("blur.validate-equalTo", function() { c(b).valid(); });
                return a == d.val();
            }
        }
    });
