...
(function(u, p, f, q) {
    var o = f(u), n = f(p), b = f.fancybox = function() { b.open.apply(this, arguments); }, z = null, m = p.createTouch !== q, x = function(a) { return a && a.hasOwnProperty && a instanceof f; }, s = function(a) { return a && "string" === f.type(a); }, C = function(a) { return s(a) && 0 < a.indexOf("%"); }, k = function(a, c) {
        var e = parseInt(a, 10);
    ...
    f.extend(b, {
        ...
        defaults: {
            ...
            title: null,
            tpl: {
                wrap: '<div class="fancybox-wrap box" tabIndex="-1"><div><div class="fancybox-outer"><div class="fancybox-inner"></div></div></div></div>',
                ...
                closeBtn: '<a title="ببند" class="fancybox-item fancybox-close" href="javascript:;"></a>',
                next: '<a title="برو بعدی" class="fancybox-nav fancybox-next" href="javascript:;"><span></span></a>',
                prev: '<a title="برگرد عقب" class="fancybox-nav fancybox-prev" href="javascript:;"><span></span></a>'
            },
            openEffect: "fade",
            openSpeed: 250,
            openEasing: "swing",
        ...
        open: function(a, c) {
            if (a && (f.isPlainObject(c) || (c = { }), !1 !== b.close(!0)))
                return f.isArray(a) || (a = x(a) ? f(a).get() : [a]), f.each(a, function(e, d) {
                    var j = { }, g, h, i, l, k;
                    "object" === f.type(d) && (d.nodeType && (d = f(d)), x(d) ? (j = { href: d.attr("href"), title: d.attr("title"), isDom: !0, element: d }, f.metadata &&
        ...
        play: function(a) {
            ...
            if (!0 === a || !b.player.isActive && !1 !== a) {
                if (b.current && (b.current.loop || b.current.index < b.group.length - 1)) b.player.isActive = !0, f("body").bind({ "afterShow.player onUpdate.player": e, "onCancel.player beforeClose.player": d, "beforeLoad.player": c }), e(), b.trigger("onPlayStart");
            } else d();
        },
        next: function(a) {
            var c = b.current;
        ...
        showLoading: function() {
            var a, c;
            b.hideLoading();
            n.bind("keypress.fb", function(a) { if (27 === (a.which || a.keyCode)) a.preventDefault(), b.cancel(); });
        ...
        bindEvents: function() {
            ...
            a && (o.bind("orientationchange.fb" + (m ? "" : " resize.fb") + (a.autoCenter && !a.locked ? " scroll.fb" : ""), b.update), (c = a.keys) && n.bind("keydown.fb", function(e) {
                ...
                for (var h = f(c.target || null), i = !1; h.length && !i && !h.is(".fancybox-skin") && !h.is(".fancybox-wrap");)
        ...
        trigger: function(a, c) {
            ...
            if (d) {
                ...
                d.helpers && f.each(d.helpers,
                    function(c, e) { if (e && b.helpers[c] && f.isFunction(b.helpers[c][a])) b.helpers[c][a](e, d); });
                f.event.trigger(a + ".fb");
            }
        },
        isImage: function(a) { return s(a) && a.match(/\.(jp(e|g|eg)|gif|png|bmp|webp)((\?|#).*)?$/i); },
        isSWF: function(a) { return s(a) && a.match(/\.(swf)((\?|#).*)?$/i); },
        _start: function(a) {
            var c = { }, e, d, a = k(a);
            e = b.group[a] || null;
            if (!e) return !1;
            ...
            if (!1 === b.trigger("beforeLoad")) b.coming = null;
                ...
                f.each(["Top", "Right", "Bottom", "Left"], function(a, b) { c.skin.css("padding" + b, v(c.padding[a])); });
                b.trigger("onReady");
                if ("inline" === d || "html" === d) {
                    if (!c.content ||
        ...
        _loadAjax: function() {
            var a = b.coming;
            b.showLoading();
            b.ajaxLoad = f.ajax(f.extend({ }, a.ajax, { url: a.href, error: function(a, e) { b.coming && "abort" !== e ? b._error("ajax", a) : b.hideLoading(); }, success: function(c, e) { "success" === e && (a.content = c, b._afterLoad()); } }));
        },
        ...
        _setDimension: function() {
            ...
            if ("iframe" === h.type) {
                if (E = h.content, h.autoHeight && 1 === E.data("ready"))
                    try {
            ...
            if (h.aspectRatio) {
                ...
                d = Math.max(l, Math.min(d,
                    m)), i = Math.max(t, Math.min(i, n));
            if (h.fitToView)
                if (m = Math.min(a.w - r, m), n = Math.min(a.h - u, n), g.width(k(d)).height(k(i)), e.width(k(d + w)), a = e.width(), r = e.height(), h.aspectRatio) for (; (a > o || r > p) && (d > l && i > t) && !(19 < c++);) i = Math.max(t, Math.min(n, i - 10)), d = i * B, d < l && (d = l, i = d / B), d > m && (d = m, i = d / B), g.width(k(d)).height(k(i)), e.width(k(d + w)), a = e.width(), r = e.height();
            ...
            f.extend(h, { dim: { width: v(a), height: v(r) }, origWidth: A, origHeight: y, canShrink: e, canExpand: d, wPadding: w, hPadding: x, wrapSpace: r - j.outerHeight(!0), skinSpace: j.height() - i });
            !E && (h.autoHeight && i > t && i < n && !d) && g.height("auto");
        },
        _getPosition: function(a) {
            var c = b.current, e = b.getViewport(), d = c.margin, f = b.wrap.width() + d[1] + d[3], g = b.wrap.height() + d[0] + d[2], d = { position: "absolute", top: d[0], left: d[3] };
            c.autoCenter &&
        ...
        _afterZoomIn: function() {
            ...
            a && ((b.isOpen = b.isOpened = !0, b.wrap.addClass("fancybox-opened").css("overflow", "visible"), b.reposition(), (a.closeClick || a.nextClick) && b.inner.css("cursor", "pointer").bind("click.fb", function(c) {
                if (!f(c.target).is("a") && !f(c.target).parent().is("a"))
    ...
    b.transitions = {
        getOrigPosition: function() {
            ...
            return d = { top: v(d.top - h * a.topRatio), left: v(d.left - i * a.leftRatio), width: v(f + i), height: v(g + h) };
        },
        step: function(a, c) {
            var e, d, f = c.prop;
            d = b.current;
        ...
        zoomIn: function() {
            ...
            b.wrap.css(c).animate(j, { duration: "none" === e ? 0 : a.openSpeed, easing: a.openEasing, step: d ? this.step : null, complete: b._afterZoomIn });
        },
        zoomOut: function() {
        ...
        changeIn: function() {
            ...
            "none" === c ? b._afterZoomIn() : b.wrap.css(e).animate(d, { duration: a.nextSpeed, easing: a.nextEasing, complete: b._afterZoomIn });
        },
        changeOut: function() {
            var a = b.previous, c = a.prevEffect, e = { opacity: 0.1 }, d = b.direction;
            "elastic" === c &&
                (e["down" === d || "up" === d ? "top" : "left"] = ("up" === d || "left" === d ? "-" : "+") + "=200px");
            a.wrap.animate(e, { duration: "none" === c ? 0 : a.prevSpeed, easing: a.prevEasing, complete: function() { f(this).trigger("onReset").remove(); } });
        }
    };
    b.helpers.overlay = {
        overlay: null,
        ...
        onReady: function(a,
            ...
            this.overlay || f.extend(this, { overlay: f('<div class="fancybox-overlay"></div>').appendTo(b.parent), margin: n.height() > o.height() || "scroll" === f("body").css("overflow-y") ? f("body").css("margin-right") : !1, el: p.all && !p.querySelector ? f("html") : f("body") });
        ...
        beforeShow: function(a, c) {
            ...
            a.closeClick && e.bind("click.fb", function(a) { f(a.target).hasClass("fancybox-overlay") && b.close(); });
            c.fixed && !m ? c.locked && (this.el.addClass("fancybox-lock"), !1 !== this.margin && f("body").css("margin-right", k(this.margin) + c.scrollbarWidth) && f("header").css("padding-right", k(this.margin) + c.scrollbarWidth)) : this.update();
            e.show();
        },
        onUpdate: function(a, b) { (!b.fixed || m) && this.update(); },
        afterClose: function(a) {
            var c = this, a = a.speedOut || 0;
            c.overlay && !b.isActive && c.overlay.fadeOut(a || 0, function() {
                f("body").css("margin-right", c.margin);
                f("header").css("padding-right", c.margin);
