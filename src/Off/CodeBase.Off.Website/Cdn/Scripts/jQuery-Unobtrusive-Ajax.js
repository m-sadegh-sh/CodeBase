...
(function(a) {
    ...
    function d(a) { return a === "GET" || a === "POST"; }

    function f(b, a) { !d(a) && b.setRequestHeader("X-HTTP-Method-Override", a); }
    ...
    function h(c, b, e) {
        ...
        a(c.getAttribute("data-ajax-update")).each(function(f, c) {
            ...
            case "BEFORE":
                e = c.firstChild;
                a("<div />").html(b).contents().each(function() { c.insertBefore(this, e); });
                break;
            case "AFTER":
                a("<div />").html(b).contents().each(function() { c.appendChild(this); });
                break;
            default:
                a(c).html(b);
            }
    ...
    a("form[data-ajax=true] input[type=image]").live("click", function(c) {
        ...
        setTimeout(function() { a(f).removeData(b); }, 0);
    });
    a("form[data-ajax=true] :submit").live("click", function(c) {
        ...
        setTimeout(function() { a(d).removeData(b); }, 0);
    });
